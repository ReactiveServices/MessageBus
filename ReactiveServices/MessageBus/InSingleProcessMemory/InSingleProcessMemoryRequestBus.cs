...
{
    public class InSingleProcessMemoryRequestBus : InSingleProcessMemoryMessageBus, IRequestBus
    {
        public InSingleProcessMemoryRequestBus()
        {
        ...
        private readonly Queue<InSingleProcessMemorySubscription> RepliesSubscriptions = new Queue<InSingleProcessMemorySubscription>();
        ...
        protected virtual InSingleProcessMemorySubscription NewResponseSubscription(
