...
{
    public class InSingleProcessMemorySendingBus : InSingleProcessMemoryMessageBus, ISendingBus
    {
            ...
            Dictionary<string, string> headers, TimeSpan expiration)
        {
            ...
            {
                Log.Error(String.Format("Could not send message of type '{0}' and delivery tag {1}!", messageType.Name, deliveryTag), e);
